...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', async () => {
        ...
        expect(await jobHistoryComponentsPage.getTitle()).to.eq('jhipsterApp.jobHistory.home.title');
    });
    ...
    it('should load create JobHistory page', async () => {
        ...
        expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('jhipsterApp.jobHistory.home.createOrEditLabel');
    ...
    it('should delete last JobHistory', async () => {
        ...
        expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.jobHistory.delete.question');
